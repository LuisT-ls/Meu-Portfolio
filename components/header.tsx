...
export function Header() {
  ...
  return (
    ...
    >
      {/* Backdrop blur bar — usa tokens semânticos: canvas adapta-se ao tema */}
      <motion.div
        initial={false}
        animate={{
        ...
        className="absolute inset-0 bg-canvas/85 border-b border-line shadow-sm -z-10"
      />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          ...
          <Link
            href="/"
            aria-label="Início"
            className="relative text-2xl font-display font-bold tracking-tighter text-brand group"
          >
            LT.
            <span className="absolute -bottom-0.5 left-0 w-0 h-0.5 bg-brand group-hover:w-full transition-all duration-300 rounded-full" />
          </Link>
                  ...
                  <li key={link.href} className="relative">
                    ...
                    >
                      ...
                      {isActive && (
                        <motion.span
                          layoutId="active-dot"
                          className="relative ml-1.5 w-1 h-1 rounded-full bg-brand"
                          transition={{ type: 'spring', stiffness: 380, damping: 35 }}
                        />
                      )}
                    </Link>
          ...
          <div className="flex items-center gap-1.5">
            ...
            <a
              ...
              className="w-9 h-9 flex items-center justify-center rounded-full text-content-secondary hover:bg-surface hover:text-content transition-all duration-200"
            >
          ...
          >
                    ...
                    <Link
                      ...
                      className={cn(
                        ...
                        isActive
                          ...
                          : 'text-content hover:bg-surface hover:text-content'
                      )}
                    >
                      <span className={cn(
            ...
            <div className="p-3 pt-0">
              <a
                ...
                onClick={handleLinkClick}
                aria-label="Baixar currículo em PDF"
                className="flex items-center justify-center gap-2 w-full px-4 py-3 bg-brand text-content-on-brand rounded-xl font-semibold text-sm hover:bg-brand-hover transition-colors"
              >
                <i className="fas fa-download text-xs"></i>
                Baixar Currículo
              </a>
